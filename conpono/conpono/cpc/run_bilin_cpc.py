...
flags.DEFINE_string(
    "train_file", "../../../data/test_target.tfrecord",
    "The input data. Should be in tfrecord format ready to input to BERT.")

flags.DEFINE_string(
    "bert_config_file", "../../../bert_config/bert_config.json",
...
flags.DEFINE_bool("include_mlm", True, "Whether to include MLM loss/objective") # use masks
...
flags.DEFINE_bool("include_context", True, "Whether to include context.") # include context for target?
